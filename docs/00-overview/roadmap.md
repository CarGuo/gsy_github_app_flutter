...
### 2.3 flutter analyze 7 条历史 warning

久违的技术债，不影响功能，但每次 CI 输出脏：

- [event_bus.dart#L37](file:///Users/guoshuyu/workspace/flutter-work/gsy_github_app_flutter/lib/common/event/event_bus.dart#L37)：doc comment 里 `<...>` 需要转义或反引号
- [gsy_state.dart#L32](file:///Users/guoshuyu/workspace/flutter-work/gsy_github_app_flutter/lib/redux/gsy_state.dart#L32)：同上
- [gsy_markdown_widget.dart#L136](file:///Users/guoshuyu/workspace/flutter-work/gsy_github_app_flutter/lib/widget/markdown/gsy_markdown_widget.dart#L136)：同上
- [gsy_markdown_widget.dart#L358](file:///Users/guoshuyu/workspace/flutter-work/gsy_github_app_flutter/lib/widget/markdown/gsy_markdown_widget.dart#L358)：同上
- [flutter_radial_menu.dart#L1](file:///Users/guoshuyu/workspace/flutter-work/gsy_github_app_flutter/lib/widget/menu/flutter_radial_menu.dart#L1)：`library` 名多余
- [nested_refresh.dart#L526](file:///Users/guoshuyu/workspace/flutter-work/gsy_github_app_flutter/lib/widget/pull/nested/nested_refresh.dart#L526)：`axisAlignment` deprecated
- [pubspec.yaml](file:///Users/guoshuyu/workspace/flutter-work/gsy_github_app_flutter/pubspec.yaml)：git 依赖 + 没写 `publish_to: none`

### 2.4 CI 只保证"能编译"

GitHub Actions 目前只跑 build，不跑 `flutter test`。
仓库里的 `test/utils/event_utils_test.dart`、`test/model/issue_timeline_event_test.dart`、
`test/widget/issue_timeline_item_test.dart`、`test/widget/markdown_html_transformer_test.dart`
完全没进 CI，本地跑一次绿就上，等于**代码变了、测试没跟着跑**的地方靠自觉。

修法：在 Actions workflow 里加一步 `flutter test`，产出报告就够了。
...
1. **最低阻力**：修 2.3 的 markdown doc warning + 补 2.1 里 `auto_merge_enabled/disabled` 两个 action。10 分钟一个 commit。
