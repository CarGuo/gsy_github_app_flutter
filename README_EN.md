...
1. Configure the Flutter development environment (Tag of the current version of Flutter SDK ** v1.1.3 **).
...
>### Local Flutter SDK version v1.1.3 or more. 2. Does the third-party package version in pubspec. yaml correspond to the third-party package version in pubspec. lock?
...
>Current Flutter SDK version v1.1.3
