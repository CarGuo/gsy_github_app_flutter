...
1. Configure the Flutter development environment (Tag of the current version of Flutter SDK  **2.8** ).
...
>### Local Flutter SDK version  2.8 or more. 2. Does the third-party package version in pubspec. yaml correspond to the third-party package version in pubspec. lock?
...
>Current Flutter SDK version **2.8**
