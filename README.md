...
1、配置好Flutter开发环境(目前Flutter SDK 版本 **3.47.2**，仓库已在 `.fvmrc` 里锁定该版本，推荐使用 [FVM](https://fvm.app/) 一键切换：`fvm install 3.47.2 && fvm use 3.47.2`)，可参阅 [【搭建环境】](https://flutterchina.club)。
...
>### 1、本地 Flutter SDK 版本 3.47.2（`.fvmrc` 已锁定，可用 `fvm use` 切换）； 2、是否执行过 `flutter pub get`；3、 网络等问题参考: [如果出现登陆失败或者请求失败 ](https://github.com/CarGuo/gsy_github_app_flutter/issues/643)
...
![Star History Chart](https://star-history-eight.vercel.app/api/svg?repos=CarGuo/gsy_github_app_flutter&type=Date)
